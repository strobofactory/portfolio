...
module.exports = (req, res) => {
  ...
  <article class="caseStudy">
    <div class="caseIntro">
      <p class="category">Accounting Automation / AI + API Integration</p>
      <h3>Accounting Automation Platform</h3>
      <p class="desc">AI・会計API・業務ツールを統合した経理オペレーション基盤</p>
    </div>
    <div class="caseBody">
      ...
      <div class="caseMeta">
        <div><strong>Scheduled</strong><span>Daily / Monthly operations</span></div>
        <div><strong>Integrated</strong><span>Accounting / Mail / Drive / Slack</span></div>
        <div><strong>Guardrailed</strong><span>Human review / Exception handling</span></div>
      </div>
